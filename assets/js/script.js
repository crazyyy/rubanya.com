$(document).ready(function(){
    ...
    jQuery('#vertical-ticker a').click(function(e){
     ...
     jQuery("a[href$='.jpg'], a[href$='.png'], a[href$='.jpeg'], a[href$='.gif']").each(function(){jQuery(this).attr("rel","img");jQuery(this).attr("title",jQuery(this).children("img").attr("title"));});
    jQuery("a[href$='.jpg'], a[href$='.png'], a[href$='.jpeg'], a[href$='.gif']").fancybox({helpers : { title: {type: 'inside'} }});
